...
(`rfc8391_adrs.encode_batch`) and stay on the host, because they are structural:
...
class Rfc8391Hashes:
    ...
    (`rfc8391_params`); neither is derivable from the other.
    """
    ...
    def _masked(
        ...
        *,
        ...
        key = self.prf(pub_seed, rfc8391_adrs.with_key_and_mask(addresses, 0))
        mask = fnp.concatenate(
            [
                self.prf(pub_seed, rfc8391_adrs.with_key_and_mask(addresses, word + 1))
